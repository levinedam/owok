...
class Giveaway(commands.Cog):
    ...
    async def _safe_scan(self):
        ...
        # Give a small buffer for other systems to stabilize
        await asyncio.sleep(5)
        
        # Initialize DB with unique username now that we are ready
            ...
            try:
                ...
                if not channel:
                     try:
                        ...
                        # self.bot.log("WARN", f"Giveaway channel {channel_id} inaccessible: {e}")
                        continue
    ...
    async def cog_load(self):
        # Move logic to background task to allow startup to complete
    ...
    async def on_message(self, message):
        ...
        # Ensure we are ready before processing live messages
